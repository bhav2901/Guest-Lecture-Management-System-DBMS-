...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-block btn-sm btn-primary col-sm-2" type="button" id="new_theater"><i class="fa fa-plus"></i> New Auditorium</button>
			...
			<div class="card-body">
				<table class="table table-bordered">
					<thead>
						<tr>
							<th class="text-center">Sl.No</th>
							<th class="text-center">Auditorium</th>
